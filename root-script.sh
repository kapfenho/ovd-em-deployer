...
groupadd -g 6201 dba
groupadd -g 6202 oem
groupadd -g 6203 oemagent

useradd -u 5100 -g 6100 -G oinstall          fmwuser
useradd -u 5200 -g 6200 -G oinstall,dba      oracle
useradd -u 5300 -g 6202 -G oinstall,oem      oem
useradd -u 5300 -g 6203 -G oinstall,oemagent oemagent
...
install  --owner=fmwuser --group=fmwgroup --mode=0775 --directory /var/log/oem
install  --owner=fmwuser --group=fmwgroup --mode=0775 --directory /var/log/oemagent
